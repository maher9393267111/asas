...
import WhatsappForm from "../../app/(servicespages)/service/_components/WhatsappForm";
SwiperCore.use([Autoplay, EffectFade, Navigation, Pagination]);

const BannerService = ({ data }) => {
                  ...
                  return (
                    <SwiperSlide className="swiper-slide">
                      <div
                        ...
                        style={{
                          backgroundImage: `linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(${item?.images[0]})`,
                        }}
                      >
                        <div className="container">
                          <div className="row">
                            <div className="col-lg-12">
                              <div className="home1-banner-content ar">
                                <div className="eg-tag ar">
                                  <span>
                                    <svg
                                ...
                                {/* <h5 className="ar text-white text-3xl">
