                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-lg-6">
                      <div className="row g-3">
                        ...
                        {hotel?.images?.length > 0 && hotel?.images[2] && (
                          <div className="col-6">
                            <div className="gallery-img-wrap">
                              <img
                                src={hotel?.images[2]}
                        ...
                        {hotel?.images?.length > 0 && hotel?.images[3] && (
                          <div className="col-6">
                            <div className="gallery-img-wrap">
                              <img
                                src={hotel?.images[3]}
                      ...
                      <div className="col-6">
                        <div className="gallery-img-wrap active">
                          <img src="/assets/img/innerpage/room-05.jpg" alt="" />
                          <a
                  ...
                  {hotel?.airCondition && (
                    <li className=" !font-kufi">
                      ...
                      >
                        ...
                        <path d="M11.1445 20.8008C11.0215 20.918 11.0156 20.9531 11.0156 22.3828C11.0156 23.7715 11.0215 23.8535 11.1328 23.9649C11.2793 24.1113 11.5488 24.1172 11.7246 23.9707L11.8652 23.8594V22.3828V20.9063L11.7246 20.7949C11.5488 20.6485 11.3027 20.6543 11.1445 20.8008Z"></path>
                        <path d="M14.8242 20.8008C14.7129 20.9121 14.707 20.9942 14.707 22.3828C14.707 23.7715 14.7129 23.8535 14.8242 23.9649C14.9707 24.1113 15.2402 24.1172 15.416 23.9707L15.5566 23.8594V22.3828V20.9063L15.416 20.7949C15.2402 20.6485 14.9707 20.6543 14.8242 20.8008Z"></path>
                        <path d="M18.2754 20.7949L18.1348 20.9063V22.3711C18.1348 23.7305 18.1406 23.8418 18.2461 23.959C18.3926 24.1172 18.709 24.1231 18.8672 23.9649C18.9785 23.8535 18.9844 23.7715 18.9844 22.3828C18.9844 20.9531 18.9785 20.918 18.8555 20.8008C18.6973 20.6543 18.4512 20.6485 18.2754 20.7949Z"></path>
                        <path d="M21.4157 20.8301C21.2457 20.9941 21.2399 21.1348 21.3571 21.709C21.5739 22.752 22.5875 24.082 23.1676 24.082C23.3844 24.082 23.5543 23.8887 23.5543 23.6484C23.5543 23.4785 23.5016 23.4082 23.2086 23.1504C22.6286 22.6465 22.2653 21.9785 22.1715 21.252C22.1071 20.7188 21.7321 20.5078 21.4157 20.8301Z"></path>
                      </svg>
                      المكيف
                    </li>
                  )}
...
نرحب بالأطفال. إقامة الأطفال مجانية! يتمتع الأطفال بإقامة مجانية عند استخدام الأسرّة الموجودة؛ قد لا يكون الأطفال مؤهلين للحصول على وجبة إفطار مجانية تتوفر أسرّة قابلة للطي/إضافية مقابل 10 دولارات في اليوم.
      ...
      {hotel?.images?.length > 0 && (
        <Lightbox
          ...
          slides={hotel?.images?.map(function (elem) {
            return { src: elem };
          })}
        />
      )}
...
//       <div className="   px-12 min-h-[70vh]">Hotel {hotel?.title}</div>
